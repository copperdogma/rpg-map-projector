...
- `npm run probe:esp32-webcam -- --detect-image <path> --out-dir <dir>` probes one low-resolution ESP32 webcam still with a separate quality-gated dark-line/Hough lattice seed experiment. This is a manual-seed fallback lane and does not modify the browser detector.
