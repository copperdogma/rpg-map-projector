...
Triage starts from product truth, then recommends one next action.
...
5. `docs/stories.md` and relevant story files
6. `docs/inbox.md`
7. `docs/scout.md` and relevant scout files
8. `docs/decisions/` when a hard-to-reverse decision is involved
